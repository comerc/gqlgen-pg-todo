...
dataloader:
	...
	# Note the project path of `github.com/comerc/gqlgen-pg-todo/models`
	...
	- cd graph/generated && go run github.com/vektah/dataloaden $(loader)Loader int *github.com/comerc/gqlgen-pg-todo/models.$(loader)
