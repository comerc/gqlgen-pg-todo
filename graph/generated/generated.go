...
`, BuiltIn: false},
	{Name: "../../schema/types/todo.graphql", Input: `type Todo @goModel(model: "./models.Todo") {
  id: Int!
  name: String!
...
`, BuiltIn: false},
	{Name: "../../schema/types/user.graphql", Input: `type User @goModel(model: "./models.User") {
  id: Int!
  email: String!
...
input UserInput @goModel(model: "./models.UserInput") {
  email: String!
  firstName: String!
  lastName: String!
}
